...
func TestNewProfileProducesStableFingerprint(t *testing.T) {
	...
	const wantCanonical = `{"chunker_id":"page-aware-recursive-v1","distance":"cosine","embedding_model_id":"intfloat/multilingual-e5-small","embedding_model_sha256":"ca456c06b3a9505ddfd9131408916dd79290368331e7d76bb621f1cba6bc8665","minimum_score":0.620000,"onnx_runtime_id":"onnxruntime-1.26.0","parser_id":"pdfium-wasm-1.19.6","tokenizer_sha256":"0b44a9d7b51c3c62626640cda0e2c2f70fdacdc25bbbd68038369d14ebdf4c39","vector_dimension":384}`
	if canonical != wantCanonical {
		t.Fatalf("canonical profile = %s, want %s", canonical, wantCanonical)
	}
	const wantFingerprint = "7e8430367ed8b10188d3806d07bd4a344228ffc80e3597d52cafbc936f6a8f61"
